...
%   \caption{$J(\theta) = An + \sum_{i=1}^n \left( x_i^2 - A \cos(2 \pi x_i) \right)$}
% \end{figure}
\includegraphics[scale=0.5]{assets/rastrigin}
...
%   \column{0.5\textwidth}
%     \begin{center}
%       \includegraphics[scale=0.3]{assets/sphere_colony_re_J}
%       \includegraphics[scale=0.3]{assets/sphere_colony_re_theta}
%     \end{center}
%   \column{0.5\textwidth}
% \end{columns}
% \end{frame}
