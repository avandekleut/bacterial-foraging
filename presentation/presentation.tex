...
\column{0.5\textwidth}
\begin{center}
\includegraphics[scale=0.4]{assets/sphere}
\end{center}
\column{0.5\textwidth}
\includegraphics[scale=0.4]{assets/rastrigin}
\end{columns}
\end{frame}
...
\column{0.5\textwidth}
\begin{center}
\includegraphics[scale=0.4]{assets/sphere_eval}
\end{center}
\column{0.5\textwidth}
\includegraphics[scale=0.4]{assets/rastrigin_eval}
\end{columns}
\end{frame}
